...
export const UserDashboard: React.FC = () => {
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      case 'transportation':
        return (
          <svg className="animated-icon" style={{ width: '16px', height: '16px', stroke: 'var(--accent)', fill: 'none', marginRight: '8px', flexShrink: 0 }} viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      case 'energy':
        return (
          <svg className="animated-icon" style={{ width: '16px', height: '16px', stroke: 'var(--warning)', fill: 'none', marginRight: '8px', flexShrink: 0 }} viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
          </svg>
        );
      case 'food':
        return (
          <svg className="animated-icon" style={{ width: '16px', height: '16px', stroke: 'var(--primary)', fill: 'none', marginRight: '8px', flexShrink: 0 }} viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />
          </svg>
        );
      case 'waste':
        return (
          <svg className="animated-icon" style={{ width: '16px', height: '16px', stroke: 'var(--danger)', fill: 'none', marginRight: '8px', flexShrink: 0 }} viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      case 'water':
        return (
          <svg className="animated-icon" style={{ width: '16px', height: '16px', stroke: 'var(--secondary)', fill: 'none', marginRight: '8px', flexShrink: 0 }} viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  if (loading) {
    return (
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '60vh' }}>
        <p style={{ fontSize: '1.1rem', color: 'var(--text-secondary)', textAlign: 'center', padding: '0 16px' }}>Analyzing carbon logs and updating intelligence models...</p>
      </div>
    );
  }
    ...
    <div className="animate-fade-in">
      ...
      <div className="topbar">
        ...
        <div className="user-badge">
          <span style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: 'var(--primary)', flexShrink: 0 }}></span>
          <span style={{ fontWeight: 600 }}>{user?.role} PORTAL</span>
        </div>
      </div>
      ...
      <div className="metric-grid">
        <div className="metric-card">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
            ...
            <svg className="animated-icon" style={{ width: '20px', height: '20px', stroke: 'var(--primary)', fill: 'none', flexShrink: 0 }} viewBox="0 0 24 24" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
            </svg>
          </div>
          <div className="metric-value">{data?.totalEmissionsKg.toFixed(1)} <span style={{ fontSize: '0.9rem', fontWeight: 400 }}>kg CO₂</span></div>
          <div className="metric-sub">Total logged footprint</div>
        </div>
        <div className="metric-card">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
            <div className="metric-title" style={{ marginBottom: 0 }}>Eco Score</div>
            <svg className="animated-icon" style={{ width: '20px', height: '20px', stroke: 'var(--primary)', fill: 'none', flexShrink: 0 }} viewBox="0 0 24 24" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="metric-card">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
            <div className="metric-title" style={{ marginBottom: 0 }}>Top Driver</div>
            <svg className="animated-icon" style={{ width: '20px', height: '20px', stroke: 'var(--warning)', fill: 'none', flexShrink: 0 }} viewBox="0 0 24 24" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z" />
            </svg>
          </div>
          <div className="metric-value" style={{ textTransform: 'capitalize', fontSize: '1.3rem', marginTop: '4px' }}>
            {Object.entries(categoryTotals).sort((a, b) => b[1] - a[1])[0]?.[0] || 'None'}
          </div>
          <div className="metric-sub">Priority reduction target</div>
        </div>
        <div className="metric-card">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
            <div className="metric-title" style={{ marginBottom: 0 }}>AI Actions</div>
            <svg className="animated-icon" style={{ width: '20px', height: '20px', stroke: 'var(--secondary)', fill: 'none', flexShrink: 0 }} viewBox="0 0 24 24" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m0-12.728l.707.707m11.314 11.314l.707-.707M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z" />
            </svg>
          </div>
          <div className="metric-value">{recs.length}</div>
          <div className="metric-sub">Tailored to your logs</div>
        </div>
      </div>

      {/* Score Ring + Weekly Chart - responsive grid */}
      <div className="grid-3" style={{ marginBottom: '40px' }}>
        {/* Score Ring Gauge */}
        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', gridColumn: isMobile ? '1 / -1' : undefined }}>
          ...
          <div className="sustainability-ring">
            <svg width="150" height="150" viewBox="0 0 150 150" role="img" aria-label={`Sustainability score gauge: ${data?.sustainabilityScore} out of 100`}>
              ...
              <circle cx="75" cy="75" r="65" fill="none" stroke="var(--bg-input)" strokeWidth="10" />
              <circle
            ...
            {data?.weeklyTrend.map((t, idx) => {
              ...
              return (
                <div key={idx} className="bar-column" role="img" aria-label={`Emissions on ${t.day}: ${t.co2.toFixed(1)} kg CO2`}>
                  <div className="bar-graphic" style={{ height: `${pct}%` }} data-value={t.co2.toFixed(1)} />
              ...
              return (
                <div key={cat}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem', marginBottom: '6px', textTransform: 'capitalize' }}>
                    ...
                    <span style={{ color: 'var(--text-secondary)', fontSize: '0.8rem' }}>{val.toFixed(1)} kg ({pct}%)</span>
                  </div>
              ...
              <div key={rec.id} className="rec-card animate-fade-in">
                <div className="rec-info">
                  ...
                  <div className="rec-meta">
                    ...
                    <span style={{ color: 'var(--secondary)' }}>💵 ${rec.costSavingsEst}/mo</span>
                  </div>
                </div>
                <div style={{ textAlign: 'center', paddingLeft: '12px', flexShrink: 0 }}>
                  <div style={{ fontSize: '1.2rem', fontWeight: 800, color: 'var(--primary)' }}>
                    -{rec.estimatedCo2ReductionKg}
                  </div>
                  <div style={{ fontSize: '0.65rem', color: 'var(--text-muted)', whiteSpace: 'nowrap' }}>kg CO₂ / mo</div>
                </div>
              </div>
            ))}
